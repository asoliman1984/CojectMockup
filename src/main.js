...
import { highlightElement, showProperties, removeElement, exportAsImage } from './properties.js';
    ...
    script.onload = function() {
        fetch('../src/elements.json')
            ...
            .then(data => {
                ...
                window.CojectMockup = {
                    addElement: (type) => addElement(type, elementsArray, nextX, nextY, offset, elementTypes),
